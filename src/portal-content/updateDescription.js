 ...
 */
export default function(portal, username, folder, id, description, token, withCredentials=false) {

  let postData = JSON.parse(description);
  /**
   ...
   */
  postData.forEach(function(item, value) {
    if (value === null) {
      postData[item] = '';
